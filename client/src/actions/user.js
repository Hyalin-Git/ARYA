...
export async function updateUserPicture(uid, prevState, formData) {
	try {
		...
		const res = await fetch(
			`http://arya-4pmj.onrender.com/api/users/update-picture/${uid}`,
			{
				method: "PUT",
				credentials: "include",
				headers: {
...
export async function updateUser(uid, prevState, formData) {
	try {
		...
		const res = await fetch(
			`http://arya-4pmj.onrender.com/api/users/update-user/${uid}`,
			{
				method: "PUT",
				credentials: "include",
				headers: {
...
export async function updateUserSocial(uid, prevState, formData) {
	try {
		...
		const res = await fetch(
			`http://arya-4pmj.onrender.com/api/users/update-social/${uid}`,
			{
				method: "PUT",
				credentials: "include",
				headers: {
...
export async function updateUserTools(uid, tools, prevState, formData) {
	try {
		...
		const res = await fetch(
			`http://arya-4pmj.onrender.com/api/users/update-tools/${uid}`,
			{
				method: "PUT",
				credentials: "include",
				headers: {
...
export async function sendEmailResetLink(uid, prevState, formData) {
	try {
		...
		const res = await fetch(
			`http://arya-4pmj.onrender.com/api/users/email-reset/${uid}`,
			{
				method: "POST",
				credentials: "include",
				headers: {
...
export async function updateUserPassword(uid, prevState, formData) {
	try {
		...
		const res = await fetch(
			`http://arya-4pmj.onrender.com/api/users/update-password/${uid}`,
			{
				method: "PUT",
				credentials: "include",
				headers: {
...
export async function updateForgotPassword(prevState, formData) {
	try {
		const res = await axios({
			method: "PUT",
			url: "http://arya-4pmj.onrender.com/api/users/forgot-password",
...
export async function blockUser(uid, prevState, formData) {
	try {
		...
		const response = await fetch(
			`http://arya-4pmj.onrender.com/api/users/block/${uid}`,
			{
				method: "PATCH",
				credentials: "include",
				headers: {
...
export async function unblockUser(uid, prevState, formData) {
	try {
		...
		const response = await fetch(
			`http://arya-4pmj.onrender.com/api/users/unblock/${uid}`,
			{
				method: "PATCH",
				credentials: "include",
				headers: {
...
export async function deleteUserAccount(uid, prevState, formData) {
	try {
		...
		const res = await fetch(`http://arya-4pmj.onrender.com/api/users/${uid}`, {
			method: "DELETE",
			credentials: "include",
			headers: {
				Authorization: `Bearer ${cookies().get("session")?.value}`,
